...
<head>
  ...
  <link rel="stylesheet" href="/gcp/lib/w3.css">
  ...
  .bkimg {
    ...
    background-image: url("/gcp/assets/img/solar-panel-1.jpg");
    min-height: 50%;
  }
  </style>
</head>
...
<div class="w3-cell-row w3-padding">
  <span class="w3-cell">
    <img src="/gcp/assets/img/gcs-logo-name-335x57.png">
  </span>
  <span class="w3-cell w3-right w3-large">
    <a href="/gcp/user/login" class="w3-btn w3-green">Login</a>
  </span>
</div>
