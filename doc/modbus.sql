...
-- Dumping data for table gcp.modbus: ~84 rows (approximately)
/*!40000 ALTER TABLE `modbus` DISABLE KEYS */;
INSERT INTO `modbus` (`address`, `data_type`, `tag_name`, `description`, `comments`) VALUES
	('20038', 'Float', 'S_Gen_real_enrg', 'Gen. real energy', 'Alternative is modbus 20680 *** /  Maybe good to put get this data as well.  '),
	...
	('20520', 'Bool', 'M_86MLo_Tr', '86U Lock Out Trip', '86U or 86M are the same.  Sometimes they use U for Utility or M for Main.  These are the same breaker'),
	...
	('20694', 'Float', 'Remote_Start', 'Remote Start Initiated', ''),
	...
	('22408', 'DWord', 'COM4_IPAddress ', 'Bell SIM IPAdress', ''),
	('22410', 'Byte', 'Signal_Strength ', 'Bell SIM Signal_Strength', ''),
	('22413', 'Byte', 'COM4_ModemState', 'Bell SIM Modem State', '');
